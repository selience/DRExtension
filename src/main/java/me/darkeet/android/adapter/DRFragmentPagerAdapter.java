...
/**
 * Name: DRFragmentPagerAdapter
 * User: Lee (darkeet.me@gmail.com)
 * Date: 2015/10/15 18:10
 * Desc: 封装常用adpater操作
 */
public class DRFragmentPagerAdapter extends FragmentStatePagerAdapter {
    private Context mContext;
    private final List<TabInfo> mFragments;
    private final SparseArray<Fragment> registerFragments;

    public DRFragmentPagerAdapter(Context context, FragmentManager fm) {
        super(fm);
