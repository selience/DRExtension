...
public class SectionedListAdapter extends BaseAdapter {
    ...
    public SectionedListAdapter(Context context, int sectionResourceId, ListAdapter baseAdapter) {
        mContext = context;
    ...
    public boolean isEnabled(int position) {
        return isSectionHeaderPosition(position)
                ? false : mBaseAdapter.isEnabled(sectionedPositionToPosition(position));
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        if (isSectionHeaderPosition(position)) {
            ...
            if (view == null) {
                view = (TextView) LayoutInflater.from(mContext).inflate(mSectionResourceId, parent, false);
            }
